...
public class GraficoHumedad extends AppCompatActivity {


    private LineChart graficoHumedad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grafico_humedad);
        graficoHumedad = (LineChart)findViewById(R.id.graficoHumedad);
        actualizarGraficoTemperatura();
        graficoHumedad.getAxisLeft().setDrawGridLines(false);
        graficoHumedad.getXAxis().setDrawGridLines(false);
        graficoHumedad.getAxisRight().setDrawGridLines(false);
        graficoHumedad.setNoDataText("Humedad relativa no disponible");
    }
    ...
    public void actualizarGraficoTemperatura(){
        ...
        String sensor_authkey = "VIbSnGKyLW";
        ...
        call.enqueue(new Callback<RespuestaDato>() {
            ...
            public void onResponse(Call<RespuestaDato> call, Response<RespuestaDato> response) {
                if(response.isSuccessful()){
                    ...
                    graficoHumedad.setData(lineData);
